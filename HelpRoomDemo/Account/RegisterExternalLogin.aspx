<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="HelpRoomDemo.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="HelpRoomDemo" %>
